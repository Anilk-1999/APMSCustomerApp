...
public class OperatorMachineSubscriptionSteps {
    ...
    public OperatorMachineSubscriptionSteps(AppHooks hooks, ScenarioContext context) {
    ...
    public void userHasAlreadyCreatedAnOperatorWithMachineSubscriptions() {
        String name = GlobalTestData.get("global_operator_with_machine_sub_name");
        if (name == null) {
            name = GlobalTestData.get(GlobalTestData.OPERATOR_NAME);
            if (name == null) {
    ...
    public void userLongPressesOnOperatorRecord() {
        ...
        Assert.assertNotNull(name, "Operator Name not in context — cannot long press");
    ...
    public void actionMenusBottomSheetShouldBeDisplayed() {
        Assert.assertTrue(page().isActionMenusBottomSheetDisplayed(),
                "Action Menus bottom sheet not displayed after long pressing Operator record");
    }
