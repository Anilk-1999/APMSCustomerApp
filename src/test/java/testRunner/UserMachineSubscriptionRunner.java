...
@CucumberOptions(
    ...
    plugin = {
        "pretty",
        "html:target/cucumber-reports/user-machine-subscription.html",
        "json:target/cucumber-reports/user-machine-subscription.json",
        "com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"
    },
    monochrome = true
)
public class UserMachineSubscriptionRunner {
}
