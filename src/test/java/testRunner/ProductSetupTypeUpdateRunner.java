...
@CucumberOptions(
    ...
    plugin = {
        "pretty",
        "html:target/cucumber-reports/product-setup-type-update.html",
        "json:target/cucumber-reports/product-setup-type-update.json",
        "com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"
    },
    monochrome = true
)
public class ProductSetupTypeUpdateRunner {
}
