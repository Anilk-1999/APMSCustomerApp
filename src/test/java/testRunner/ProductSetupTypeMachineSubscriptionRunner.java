...
@CucumberOptions(
    ...
    plugin = {
        "pretty",
        "html:target/cucumber-reports/product-setup-type-machine-subscription.html",
        "json:target/cucumber-reports/product-setup-type-machine-subscription.json",
        "com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"
    },
    monochrome = true
)
public class ProductSetupTypeMachineSubscriptionRunner {
}
